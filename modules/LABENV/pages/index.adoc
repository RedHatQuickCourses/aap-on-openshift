...
. **Search** for the catalog entry: **Product Enablement: Ansible Automation Platform Operator Deployment** .
+
image::2.png[]
...
=== Important Notes:
- This lab may take approximately **50 minutes** for **Product Enablement: Ansible Automation Platform Operator Deployment** .
...
[[RHDP-Portal-Links]]
=== RHDP Portal Links
- RedHat associates: https://catalog.demo.redhat.com/catalog?search=Product+Enablement+AAP+Operator+Deployment+lab[Product Enablement: Ansible Automation Platform Operator Deployment,window=_balnk]
- RedHat partners: https://catalog.partner.demo.redhat.com/catalog?search=Product+Enablement+AAP+Operator+Deployment+lab[Product Enablement: Ansible Automation Platform Operator Deployment,window=_balnk]
