...
** Content from xref:23-content-execute.adoc[Lab 2.3 Develop Playbook and Execute within AAP]
* **Prepares you for:** Using Configuration as Code to install and configure AAP
